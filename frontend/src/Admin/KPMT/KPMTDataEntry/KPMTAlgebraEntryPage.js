...
const renderSuggestion = suggestion => (
	<div style={{ display: 'inline', cursor: 'pointer' }}>{suggestion.number.toString()}</div>
)
			...
			<div className="fullheight">
				...
				<div
					...
					<div
						...
						<p>
							Select a team by first typing in its team number, use tab
					...
					<div
						...
						{this.state.selectedTeam && (
							<div style={{ marginTop: '4em' }}>
								...
								<h2>Scores</h2>
								<h3>
									Algebra: {selectedTeam.scores.algebra}
								</h3>
								<h3>
									Geometry: {selectedTeam.scores.geometry}
								</h3>
								<h3>
									Probability: {selectedTeam.scores.probability}
								</h3>
