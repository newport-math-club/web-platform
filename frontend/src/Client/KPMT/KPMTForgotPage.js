...
import { forgotKPMTPass } from '../../nmc-api'

export default class KPMTForgotPage extends Component {
	constructor(props) {
		super(props)
	...
	handlePassResetRequest = async () => {
		...
		const response = await forgotKPMTPass(email)
		...
		return (
			<div className="fullheight">
				...
				<div
					...
					<h1>recover kpmt account password</h1>
					<Textbox
